import 'package:efficient_works/screens/user/restaurant_edit.dart';
...
class _RestaurantListPageState extends State<RestaurantListPage> {
  ...
  // Map display labels -> normalized backend values
  ...
  Future<void> loadAllRestaurants() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Error loading restaurants: $e')));
    }
  }
  ...
  // ----------------------------------------------------------------------
  void applyFilters() {
    List<dynamic> temp = List.from(allRestaurants);
    ...
    List<dynamic> afterDateFilter = List.from(temp);
            ...
            return statuses.map((status) {
              return Row(
                children: [
                  ...
                  if (selectedStatus == status) const SizedBox(width: 8),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              // Edit button (optional - you can remove if edit functionality not needed)
              InkWell(
                onTap: () async {
          ...
          // ---------------- ADDRESS ----------------
          Text(
            r["location"] ?? "Address not available",
